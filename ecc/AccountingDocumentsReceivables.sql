SELECT
  ...
  IF(`{{ project_id_tgt }}.{{ dataset_reporting_tgt }}.Fiscal_Period_ecc`(AccountingDocuments.Client_MANDT,
      CompaniesMD.FiscalyearVariant_PERIV,
    ...
    IF(`{{ project_id_tgt }}.{{ dataset_reporting_tgt }}.Fiscal_Period_ecc`(AccountingDocuments.Client_MANDT,
      ...
      `{{ project_id_tgt }}.{{ dataset_reporting_tgt }}.Fiscal_Case2_ecc`(AccountingDocuments.Client_MANDT,
        CompaniesMD.FiscalyearVariant_PERIV,
        AccountingDocuments.PostingDateInTheDocument_BUDAT),
      IF(`{{ project_id_tgt }}.{{ dataset_reporting_tgt }}.Fiscal_Period_ecc`(AccountingDocuments.Client_MANDT,
          CompaniesMD.FiscalyearVariant_PERIV,
          AccountingDocuments.PostingDateInTheDocument_BUDAT) = 'CASE3',
        `{{ project_id_tgt }}.{{ dataset_reporting_tgt }}.Fiscal_Case3_ecc`(AccountingDocuments.Client_MANDT,
          CompaniesMD.FiscalyearVariant_PERIV,
          AccountingDocuments.PostingDateInTheDocument_BUDAT),
