...
SELECT
  ...
  BUT000.BP_EEW_DUMMY AS DummyFunctionInLength1_BP_EEW_DUMMY, BUT000.ZZ_FUL AS FullAddress_ZZ_FUL,
  BUT000.NAPR AS BusinessPartnerIsANaturalPersonUnderTheTaxLaws_NAPR, BUT000.BBP_IPISP AS TaxSplit_BBP_IPISP,
  BUT000.RATE AS CostRaterevenueRateForProjectCosting_RATE, BUT000.NAME_ORG1 AS Name1OfOrganization_NAME_ORG1,
  BUT000.NAME_ORG2 AS Name2OfOrganization_NAME_ORG2, BUT000.NAME_ORG3 AS Name3OfOrganization_NAME_ORG3,
  BUT000.NAME_ORG4 AS Name4OfOrganization_NAME_ORG4, BUT000.LEGAL_ENTY AS Bp_LegalFormOfOrganization_LEGAL_ENTY,
  ...
  BUT000.KBANKS AS BankCountryKey_KBANKS, BUT000.KBANKL AS BankKeys_KBANKL, BUT000.ZZCNT_FIRST AS BusinessPartner_DateOfFirstContact_ZZCNT_FIRST,
  BUT000.ZZCNTID AS RatingOfFirstContact_ZZCNTID, BUT020.ADDRNUMBER AS BPAddressNumber_ADDRNUMBER,
